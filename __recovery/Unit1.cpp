...
//		while(true)
//		{
//			UnicodeString us = CodeEditor->Text.SubString(TempPos, TextPos - TempPos + 1);
//			int tmp = us.Pos("{");
//			if(tmp > 0 )
//			{
//				Scount++;
...
//			}
//		}
//		CodeEditor->Text = CodeEditor->Text.Insert("\r\n",TextPos + 1);
//		CodeEditor->CaretPosition = CodeEditor->TextPosToPos(TextPos + 2);
//		for(int i=0;i<Scount - Fcount;i++)
//		{
//			TextPos = CodeEditor->PosToTextPos(CodeEditor->CaretPosition);
//			CodeEditor->Text = CodeEditor->Text.Insert("    ",TextPos + 1);
//			CodeEditor->CaretPosition = CodeEditor->TextPosToPos(TextPos + 4);
//		}
//		Abort();
//	}
//	if(KeyChar == '}')
//	{
//		CodeEditor->CaretPosition = CodeEditor->TextPosToPos(CodeEditor->PosToTextPos(CodeEditor->CaretPosition) - 4);
//	}
}
//---------------------------------------------------------------------------
